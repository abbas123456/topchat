...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RoomAdministrator'
        db.create_table('client_roomadministrator', (
        ...
        db.send_create_signal('client', ['RoomAdministrator'])

        # Adding unique constraint on 'RoomAdministrator', fields ['administrator', 'room']
        db.create_unique('client_roomadministrator', ['administrator_id', 'room_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'RoomAdministrator', fields ['administrator', 'room']
        db.delete_unique('client_roomadministrator', ['administrator_id', 'room_id'])

        # Deleting model 'RoomAdministrator'
        db.delete_table('client_roomadministrator')
